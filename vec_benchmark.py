...
endpoints = (np.random.rand(10,2)-0.5)
endpoints[:,0] *= 180
endpoints[:,1] *= 90

distance = np.random.rand(10)*100000

azi = np.random.rand(10)*360
...
print timeit.timeit("v_d_benchmark(geod, points, azi, distance)", setup=setup, number = 5000)

print "-----------------"

print "BASIC LOOP DIRECT"

print timeit.timeit("d_benchmark(geod, points, azi, distance)", setup=setup, number = 5000)
...
print timeit.timeit("v_i_benchmark(geod, points, endpoints)", setup=setup, number = 5000)

print "-----------------"

print "BASIC LOOP INVERSE"

print timeit.timeit("i_benchmark(geod, points, endpoints)", setup=setup, number = 5000)
